...
> [!NOTE]
> **Historical Document** (Updated January 2026)  
> Some sections of this document are now outdated:
> - The dual state store issue (Section "State Synchronization") has been **resolved** — see [backend-refactor-complete.md](./backend-refactor-complete.md)
> - References to `lib/events.ts` are outdated — this file was **deleted** and replaced with React Context
> - ConceptDeck slide types have evolved to: `recognize`, `name`, `illustrate`, `understand`, `reflect`
